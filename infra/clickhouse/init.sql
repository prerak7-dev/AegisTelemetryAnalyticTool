...
(
    ...
    source_profile LowCardinality(String) DEFAULT 'unknown',
    priority UInt8,
...
(
    ...
    packet_out_kbps_p95 Float32,
    memory_mb_p95 Float32,
    ai_agents_active_p95 Float32,
    ai_pathfinding_requests UInt64,
    matchmaking_events UInt64,
    matchmaking_queue_p95 Float32,
    top_ability_id LowCardinality(String),
    top_event_type LowCardinality(String),
...
ORDER BY (window_start, source_profile, region, server_id, map_id, zone_id);
